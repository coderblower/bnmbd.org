...
<head>
    ...
    <title>Example - Stripe Payment Integration</title>
        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between">
                    ...
                    <strong>{{ number_format($deliveryCharge, 2) }} TK</strong>
                </li>
                <li class="list-group-item d-flex justify-content-between">
                    <span>Total (BDT)</span>
                    <strong>{{ number_format($total + $deliveryCharge, 2) }} TK</strong>
                </li>
            </ul>
        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        stripePayBtn.addEventListener('click', function () {
            // Create a new Checkout Session using the server-side endpoint you define.
