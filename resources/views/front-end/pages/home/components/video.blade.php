<div class="container-fluid testimonial py-5">
    <div class="container">
            ...
            <div class="youtube-video-card">
                <div class="youtube-video-wrapper">
                    <iframe width="100%" height="315"
                        src="{{ asset($item->video_embed_src) }}" frameborder="0"
                        allowfullscreen></iframe>
                </div>
                <div class="video-content">
                    <h4 class="video-title text-secondary"><a href="{{ route('video.details', $item->id) }}">
                    ...
                    <div class="video-details d-flex justify-content-between">
                        ...
                        <a href="{{ asset($item->youtube_url) }}" target="blank"
                            class="text-primary">
        ...
        <div class="text-end mx-auto mt-4 wow fadeIn" data-wow-delay=".3s">
            <a href="{{ route('video-page') }}" class="btn btn-primary" style="background-color: #e82629; border-color: #e82629">{{ app()->getLocale() == 'bn' ? 'আরো দেখুন...' : 'See More...' }}</a>
        </div>
    </div>
</div>