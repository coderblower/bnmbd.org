...
<div class="container-fluid py-5">
    <div class="container">
        ...
        <div class="row">
            @foreach ($notice->take(2) as $key => $item) <!-- Limit to 2 notices -->
                <div class="col-md-6">
                    <div class="blog-card">
                        <div class="description">
                            ...
                            <a href="{{ route('notice.details', $item->id) }}" class="text-primary d-flex justify-content-end">
                                <small>
        ...
        <div class="text-end mx-auto mt-4 wow fadeIn" data-wow-delay=".3s">
            <a href="{{ route('notice-page') }}" class="btn btn-primary" style="background-color: #e82629; border-color: #e82629">
